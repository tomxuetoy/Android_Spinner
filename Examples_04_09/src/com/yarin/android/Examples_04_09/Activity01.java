...
public class Activity01 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 2nd arg: textViewResourceId The resource ID for a layout file
		// containing a TextView to use when instantiating views.
		// 3rd arg: objects The objects to represent in the ListView.
		...
		m_Spinner
				.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
							int arg2, long arg3) {
						// arg2: position The position of the view in the
						// adapter
						m_TextView.setText("你的血型是：" + m_Countries[arg2]);
						// 设置显示当前选择的项; arg0: parent The AdapterView where the
						// selection happened
						// Tom Xue: tested 可有可无
